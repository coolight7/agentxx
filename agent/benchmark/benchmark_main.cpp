...
int main(int argn, char** argv) {
...

    {
        ...
        agentxx::bench::benchCodeAgentInit();
        agentxx::bench::benchCodeAgentInitWarm();
        agentxx::bench::benchCodeAgentRunConversationTurnAsync(config);
        agentxx::bench::benchCodeAgentSimpleCompletion(config);
        agentxx::bench::benchCodeAgentMultiTurn(config);
        agentxx::bench::benchCodeAgentLargeHistory(config);
    }
