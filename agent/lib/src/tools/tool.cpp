...
XXToolBase::XXToolBase(
    ...
    bool in_autoSummaryOutput, bool in_canDelayLoad, size_t in_maxRetry)
...
std::string XXToolBase::get_name() const { return name; }
...
std::string XXToolWarp::get_name() const { return inner->get_name(); }
...
XXToolWarp::execute_async(const neograph::json &arguments) {
