...
CodeGraphSearchTool::execute_async(const neograph::json &arguments) {
...
asio::awaitable<std::string>
CodeGraphContextTool::execute_async(const neograph::json &arguments) {
...
asio::awaitable<std::string>
CodeGraphCallersTool::execute_async(const neograph::json &arguments) {
  std::string symbol = arguments.value("symbol", std::string{});
  if (symbol.empty()) {
    co_return R"({"error":"Arg `symbol` is empty"})";
  }
...
asio::awaitable<std::string>
CodeGraphCalleesTool::execute_async(const neograph::json &arguments) {
  std::string symbol = arguments.value("symbol", std::string{});
  if (symbol.empty()) {
    co_return R"({"error":"Arg `symbol` is empty"})";
  }
...
asio::awaitable<std::string>
CodeGraphImpactTool::execute_async(const neograph::json &arguments) {
  std::string symbol = arguments.value("symbol", std::string{});
  if (symbol.empty()) {
    co_return R"({"error":"Arg `symbol` is empty"})";
  }
...
asio::awaitable<std::string>
CodeGraphStatusTool::execute_async(const neograph::json &arguments) {
...
asio::awaitable<std::string>
CodeGraphIndexTool::execute_async(const neograph::json &arguments) {
...
asio::awaitable<std::string>
CodeGraphPathTool::execute_async(const neograph::json &arguments) {
