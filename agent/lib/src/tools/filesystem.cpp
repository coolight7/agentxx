...
FileSystemListTool::execute_async(const neograph::json &arguments) {
...
asio::awaitable<std::string>
FilesystemGlobTool::execute_async(const neograph::json &arguments) {
  auto file_patterns =
...
asio::awaitable<std::string>
FilesystemGrepTool::readFileContent(const std::string &filepath) {
...
asio::awaitable<std::string>
FilesystemGrepTool::execute_async(const neograph::json &arguments) {
