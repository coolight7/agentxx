...
std::shared_ptr<neograph::graph::GraphEngine>
SubAgentTaskBase::getSubgraph() const {
...
SubAgentNormalTask::SubAgentNormalTask(
    std::string_view in_subAgentName, std::string_view in_subAgentDepict,
...
std::string SubAgentManagerTool::get_name() const { return "subagent_switch"; }
...
SubAgentManagerTool::execute_async(const neograph::json &arguments) {
