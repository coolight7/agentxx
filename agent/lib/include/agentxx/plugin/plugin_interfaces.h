...
inline constexpr std::string_view AgentPlugins      = PLUGINXX_IFACE_PLUGINS;
inline constexpr std::string_view AgentConfig       = PLUGINXX_IFACE_CONFIG;
inline constexpr std::string_view AgentPrompt       = AGENTXX_PLUGIN_IFACE_AGENT_PROMPT;
inline constexpr std::string_view AgentJson         = PLUGINXX_IFACE_JSON;
...
inline constexpr std::string_view AgentCoroutineRuntime = PLUGINXX_IFACE_COROUTINE_RUNTIME;
