...
2. **Read the skill's full instructions**: Use toolcall `agentxx_filesystem_read_text_file` on the path shown in the skill list above.
...
2. Read the full skill file by toolcall: `agentxx_filesystem_read_text_file`
