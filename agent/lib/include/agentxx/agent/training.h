...
protected:
    ...
    utilxx_base::Json promptVariantToJson(const PromptVariant& v) const;

    PromptVariant promptVariantFromJson(const utilxx_base::Json& j) const;
